    ...
    <header className="centered-top-container animating" role="banner">
      <div className="centered-top">
        ...
        <div className="blog-name">
          ...
          <nav role="navigation">
            <div className="section" id="page_list_top" name="Page List (Top)"><div className="widget PageList" data-version="2" id="PageList1">
              <h3 className="title">
                Pages
              </h3>
                ...
                <div className="overflowable-container overflowable-2">
                  <div className="overflowable-contents">
                    <div className="container">
                      <ul className="tabs">
                      {/* style={"display: none;"} */}
                        <li className="overflow-button-container" aria-hidden="true"><div className="overflow-button">
                          <a>More…</a>
                        </div></li><li className="overflowable-item selected" aria-hidden="false">
